...
func (u *authUsecase) FindOneUser(ctx context.Context, input FindOneUserInput) (user *entity.User, err error) {
	const errLocation = "[usecase auth/find_one_user FindOneUser] "
